...
class TrainingRequest(BaseModel):
    ...
    guarded_training: bool = True
    backup_source: str = "models"
    backup_dest: str = "backups/models"
    backup_name: str = "current"
    test_parquet: str = "data/sources/subakko/hf/Data/test-*.parquet"
